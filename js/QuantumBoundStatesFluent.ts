          ...
          currentDetails: {
            accessibleTemplate: {
              ...
              listItems: {
                ...
                timeSpeed: new FluentPattern<{ speed: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_screens_defaults_screenSummary_currentDetails_accessibleTemplate_listItems_timeSpeed', _.get( QuantumBoundStatesStrings, 'a11y.screens.defaults.screenSummary.currentDetails.accessibleTemplate.listItems.timeSpeedStringProperty' ), [{"name":"speed"}] )
              }
            }
          }
        }
