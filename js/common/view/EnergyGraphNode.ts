...
export default class EnergyGraphNode extends QBSGraphNode {
  ...
  public constructor( tandem: Tandem ) {
    ...
    const options: QBSGraphNodeOptions = {
      ...
      yTickSpacing: 5,
      accessibleHeading: QuantumBoundStatesFluent.a11y.energyGraph.accessibleHeadingStringProperty,
      accessibleParagraph: QuantumBoundStatesFluent.a11y.energyGraph.accessibleParagraphStringProperty,
      tandem: tandem
    };
