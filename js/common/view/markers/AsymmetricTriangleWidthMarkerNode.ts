...
/**
 * AsymmetricTriangleWidthMarkerNode is the marker (pair of vertical dashed lines) that shows the well width of an
...
export default class AsymmetricTriangleWidthMarkerNode extends PotentialMarkerNode<AsymmetricTrianglePotential> {
