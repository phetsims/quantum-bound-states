...
export default class PoschlTellerWidthMarkerNode extends PotentialMarkerNode<PoschlTellerPotential> {
  ...
  protected override update(): void {
    const xMax = this.chartTransform.modelToViewX( this.potential.xOffsetProperty.value + this.potential.getTotalWidth() / 2 );
