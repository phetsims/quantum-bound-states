...
export default class ImaginaryPartCheckbox extends WaveFunctionComponentCheckbox {
...
quantumBoundStates.register( 'ImaginaryPartCheckbox', ImaginaryPartCheckbox );