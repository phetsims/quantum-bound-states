...
import AverageProbabilityDensityOfBandDetailsButton from '../../superposition/view/AverageProbabilityDensityOfBandDetailsButton.js';
...
export default class AverageProbabilityDensityOfBandGraphNode extends QuantumStateGraphNode {
  ...
  public constructor( model: QBSModel, tandem: Tandem ) {
    ...
    const options: QuantumStateGraphNodeOptions = {
      ...
      createEquationDetailsButton: tandem => new AverageProbabilityDensityOfBandDetailsButton( tandem ),
      ...
      accessibleHeading: QuantumBoundStatesFluent.a11y.averageProbabilityDensityOfBandGraph.accessibleHeadingStringProperty,
      accessibleParagraph: QuantumBoundStatesFluent.a11y.averageProbabilityDensityOfBandGraph.accessibleParagraphStringProperty,
